...
Hadoop cluster is ready to use when the schedulre service and all the cassandra serviceThere will be one service for the scheduler and one each for the Journal, Name, Zookeeper, Data and Yarn nodes. are in running state.
